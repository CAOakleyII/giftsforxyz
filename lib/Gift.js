...
Meteor.startup(function() {
    if (Meteor.isServer && Gifts.find().count() < 2) {
        var gift = new Gift();
        gift.name = "FitBit",
        ...
        gift.directLink = "http://www.amazon.com/All-New-Kindle-Paperwhite-High-Resolution-Display/dp/B00OQVZDJM/";
        gift.imageUrl = "http://g-ecx.images-amazon.com/images/G/01/kindle/dp/2015/KM/feature-goesbeyondabook._V302894239_.jpg";
        gift.price = 119.99;
        gift.description = "All-New Kindle Paperwhite, High-Resolution Display (300 ppi) with Built-in Light, Wi-Fi - Includes Special Offers";
        gift.tags.push("readers");
        gift.tags.push("books");
        gift.tags.push("amazon");
        Gifts.insert(gift);
    }
});
